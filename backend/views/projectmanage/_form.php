...
$model->bsdate == '1970-01-01' ? $model->bsdate ='':'';
$model->tkandate == '1970-01-01' ? $model->tkandate ='':'';
$model->psdate == '1970-01-01' ? $model->psdate ='':'';
$model->bpjfdate == '1970-01-01' ? $model->bpjfdate ='':'';
?>
...
<div class="projectmanage-form">
    ...
    <div class="row">
      <div class="col-md-4 ">
        ...
        echo Select2::widget([
          'name' => 'Projectmanage[projectarea]',
          'value' => $model->projectarea,
      ...
      <div class="col-md-4 ">
        ...
        echo Select2::widget([
          'name' => 'Projectmanage[projecttype]',
